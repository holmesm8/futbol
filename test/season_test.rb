...
class SeasonTest < Minitest::Test
  ...
  def test_finds_total_regular_season_games_by_team
    assert_equal ({13=>1, 19=>1, 26=>1}), Season.total_regular_season_games_by_team("20172018")
  end

  def test_finds_total_postseason_games_by_team
    assert_equal ({5=>3, 4=>2, 14=>1, 1=>1, 54=>1, 28=>1}), Season.total_postseason_games_by_team("20172018")
  end

  def test_finds_total_regular_season_wins_by_team
    assert_equal ({13=>1, 19=>1, 26=>1}), Season.total_regular_season_wins_by_team("20172018")
  end

  def test_finds_total_postseason_wins_by_team
    assert_equal ({5=>1, 4=>1, 14=>1, 1=>1, 54=>1, 28=>1}), Season.total_postseason_wins_by_team("20172018")
  end

  def test_regular_season_win_percentages
    assert_equal ({26=>100.0, 19=>100.0, 13=>100.0}), Season.regular_season_win_percentages("20172018")
  end

  def test_postseason_win_percentages
    expected = {1=>100.0, 4=>50.0, 26=>0.0, 14=>100.0, 6=>0.0, 3=>0.0, 5=>33.33,
                  17=>0.0, 28=>100.0, 18=>0.0, 23=>0.0, 16=>0.0, 9=>0.0, 8=>0.0,
                  30=>0.0, 15=>0.0, 19=>0.0, 24=>0.0, 27=>0.0, 2=>0.0, 20=>0.0,
                  21=>0.0, 25=>0.0, 13=>0.0, 10=>0.0, 29=>0.0, 52=>0.0,
                  54=>100.0, 12=>0.0, 7=>0.0, 22=>0.0, 53=>0.0}
